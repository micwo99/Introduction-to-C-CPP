...
typedef struct Node {
  ...
  int len; // this member should be the number of elements in the data array (think - signed or unsigned?)
} Node;
 ...
 * (*num_elements_in_retaurned_array) is a garbage value, and this function should set its value.
...
/**
 * the function returns the average of the data of the node that the function receives
 * @param node pointer
 * @return average of the data of node
 */
double NodeAverage(Node *node );
/**
 * the function calculates the number of nodes in the linked list which contains a data that is not NULL
 * @param  linked list pointer
 * @return the num of nodes in the limked list which are not NULL
 */
...
/**
 * the function returns a node that contains the data the function receives
...
/**
 * the function initiales a empty linked list  that is allocated dynamically
 * @returna empty linked list
 */
