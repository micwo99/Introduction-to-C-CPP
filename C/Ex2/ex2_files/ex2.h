...
typedef struct Node {
  /** ??? **/ next; // this member should allow access to next node in the list (think - pointer or instance?)
  /** ??? **/ prev; // this member should allow access to next node in the list (think - pointer or instance?)
  /** ??? **/ data; // this member should be an array of ints (think - signed or unsigned?)
  /** ??? **/ len; // this member should be the number of elements in the data array (think - signed or unsigned?)
} Node;

typedef struct LinkedList
{
  /** ??? **/ head; // this member should allow access to the first node in the linked list (think - pointer or instance?)
  /** ??? **/ tail; // this member should allow access to the node at the end of the linked list (think - pointer or instance?)
} LinkedList;
